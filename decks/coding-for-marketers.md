...
info: "Instructor Edition 90 นาที: ใช้ Agentic AI tools ให้ marketer สร้างของได้จริง"
layout: cover
background: '#101010'
---
...
Instructor Edition 90 นาที สำหรับนักการตลาด เจ้าของธุรกิจ และทีม growth ที่อยากใช้ Agentic AI tools ให้สร้างหน้าเว็บ เครื่องมือ และ workflow ได้จริง โดยไม่ต้องเริ่มจากการเป็น programmer แบบดั้งเดิม
</div>

<div class="de-hero-meta">
  <div class="de-chip">🎓 Instructor Edition</div>
...
<div class="de-two-up">
  <div class="de-list-card">
    <h2>เมื่อจบ session นี้ ผู้เรียนควร...</h2>
    <ul>
  ...
  <div class="de-panel-dark">
    ...
    <p>เปิด session ด้วยการบอกชัดๆ ว่านี่ไม่ใช่ class สอน coding แบบ traditional แต่เป็น class สอน “การคุม execution ผ่าน AI”</p>
  </div>
</div>
...
<div class="de-slide-header">
  <div class="de-slide-index">04 · Instructor setup</div>
  <div class="de-kicker">Before you start</div>
</div>

<div class="de-soft-panel">
ให้ instructor เช็กก่อนว่า demo environment พร้อม, browser พร้อม, repo/example project พร้อม, และมี fallback plan ถ้า live demo พัง เช่น screenshot หรือ recorded walkthrough
</div>
...
<div class="de-slide-header">
  <div class="de-slide-index">16 · Instructor pause</div>
  <div class="de-kicker">Mini workshop</div>
</div>

<div class="de-panel-dark">
  <h2>ให้ผู้เรียนทำ 3 นาที</h2>
...
<div class="de-slide-header">
  <div class="de-slide-index">31 · Instructor checkpoint</div>
  <div class="de-kicker">Recap</div>
</div>

<div class="de-panel-dark">
  <h2>ให้ผู้เรียน recap</h2>
  <p>ให้จับคู่กันแล้วอธิบายคำว่า localhost, port, .env.local และ context window ด้วยภาษาตัวเองภายใน 2 นาที</p>
</div>
